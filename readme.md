...
A lightweight, simple-to-use horizontal bar graph web component. Pass in the data array, with the value number and color of your choice, then ui-percentage-bar will handle the rest.
